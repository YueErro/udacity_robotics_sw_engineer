...
// Import JointState header file to read back the arm joint positions
#include <sensor_msgs/JointState.h>
// Import Image header file so that we can use the camera data
#include <sensor_msgs/Image.h>

// Define global vector of joints last position, moving state of the arm, and the client
// that can request services
...
int main(int argc, char** argv)
{
  ...
  // Subscribe to /simple_arm/joint_states topic to read the arm joints position inside
  // the joint_states_callback function
